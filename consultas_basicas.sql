...
SELECT * FROM sales; --Utilizaria SELECT * solo si necesito entender la estructura completa de la tabla, si busco algo particular aclararia en SELECT lo que busco concretamente.
